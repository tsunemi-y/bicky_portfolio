...
const login = async (formData: loginFormValues, dispatch: AppDispatch) => {
  ...
  try {
    ...
    const response = await axios.post(`${process.env.NEXT_PUBLIC_API_BASE_URL}/user/login`, formData, { withCredentials: true })
